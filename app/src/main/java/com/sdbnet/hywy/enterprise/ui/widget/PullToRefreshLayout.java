...
public class PullToRefreshLayout extends RelativeLayout {
	...
	// 刷新时间 ：
	private TextView refreshStateTvDate;
	// 上拉头
	...
	public void refreshFinish(int refreshResult) {
		...
		case SUCCEED:
			...
			refreshStateTvDate.setText(getResources().getString(
					R.string.updating)
	...
	private void initView() {
		...
		refreshStateTvDate = (TextView) refreshView.findViewById(R.id.date_tv);
	...
	public void noData() {
		...
		loadStateTextView.setText("没有数据");
		new Handler() {
			@Override
			public void handleMessage(Message msg) {
				changeState(DONE);
