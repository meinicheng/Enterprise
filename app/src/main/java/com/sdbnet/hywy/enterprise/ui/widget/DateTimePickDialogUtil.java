...
public class DateTimePickDialogUtil implements OnDateChangedListener,
	...
	private Calendar getCalendarByInintData(String initDateTime) {
		...
		String[] time = initDateTime.split(" ");
		String[] dateStr = time[0].split("-");
		String[] timeStr = time[1].split(":");

		calendar.set(Integer.parseInt(dateStr[0]),
				Integer.parseInt(dateStr[1]) - 1, Integer.parseInt(dateStr[2]),
				Integer.parseInt(timeStr[0]), Integer.parseInt(timeStr[1]));
		return calendar;
	}
